...
\noindent 程序的核心逻辑是下面的\texttt{\textbf{Recursive routine solve\_24}}，
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\linewidth]{Figs/game24_promax.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\linewidth]{Figs/game24_ultra.png}
