...
\Colorbox{cmdbg}{\lstinline[language=bash]|gfortran -o brute_force -brute_force.f90|}
\Colorbox{cmdbg}{\lstinline[language=bash]|gfortran -o mod30 -mod30_trick.f90|}
\Colorbox{cmdbg}{\lstinline[language=bash]|gfortran -o mod30v2 -mod30_trick_reverse.f90|}
等命令可以编译。
编译选项$-o$后面的程序名可自选，再执行即可。
