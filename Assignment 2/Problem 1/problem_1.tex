...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{Problem 1/Figs/1_plot.pdf}  % 调整图片宽度
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1.0\textwidth]{Problem 1/figs/1_bisection.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{Problem 1/Figs/1_animation.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Problem 1/Figs/1_step.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{Problem 1/Figs/1_all.png}
